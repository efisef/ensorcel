...
var o42506 = temp__5455__auto__;
var temp__5455__auto____$1 = (o42506["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o42507 = temp__5455__auto____$1;
return (o42507["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41437__auto__ = f;
return (o__41437__auto__["toString"]).call(o__41437__auto__);
} else {
return "";
}
}catch (e42508){var _ = e42508;
return "";
}});
...
try{var o__41437__auto___42510 = t;
(o__41437__auto___42510["cljs$lang$ctorPrWriter"]).call(o__41437__auto___42510,t,writer);
}catch (e42509){var __42511 = e42509;
}
...
var char_code = (function (){var o__41437__auto__ = (new String(char$));
return (o__41437__auto__["charCodeAt"]).call(o__41437__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41437__auto__ = String;
return (o__41437__auto__["fromCharCode"]).call(o__41437__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42512 = num_code;
switch (G__42512) {
case (1):
return (185);
...
var o__41437__auto__ = String;
return (o__41437__auto__["fromCharCode"]).call(o__41437__auto__,superscript_code);
});
/**
...
}catch (e42514){var _e__41444__auto__ = e42514;
return false;
}})())){
...
var vec__42515 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__42515,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o42518 = temp__5455__auto__;
var temp__5455__auto____$1 = (o42518["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o42519 = temp__5455__auto____$1;
return (o42519["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___42526 = arguments.length;
var i__4500__auto___42527 = (0);
while(true){
if((i__4500__auto___42527 < len__4499__auto___42526)){
args__4502__auto__.push((arguments[i__4500__auto___42527]));

var G__42528 = (i__4500__auto___42527 + (1));
i__4500__auto___42527 = G__42528;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42522){
var vec__42523 = p__42522;
var ns_detector = cljs.core.nth.call(null,vec__42523,(0),null);
...
var G__42529 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__42530 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__42529;
remaining_tokens = G__42530;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42520){
var G__42521 = cljs.core.first.call(null,seq42520);
var seq42520__$1 = cljs.core.next.call(null,seq42520);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42521,seq42520__$1);
});
...
var vec__42534 = cljs.core.split_with.call(null,(function (p1__42533_SHARP_){
return cljs.core.not_EQ_.call(null,p1__42533_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__42534,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__42534,(1),null);
...
var vec__42537 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__42537,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__42537,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__42540 = cljs.core.rest.call(null,remaining_tokens);
var G__42541 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__42540;
name_tokens = G__42541;
continue;
} else {
...
var vec__42544 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__42544,(0),null);
var arity = cljs.core.nth.call(null,vec__42544,(1),null);
var vec__42547 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__42547,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__42547,(1),null);
var vec__42550 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__42550,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__42550,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__42550,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__42550,(3),null);
...
var vec__42556 = result;
var munged_ns = cljs.core.nth.call(null,vec__42556,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__42556,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__42556,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__42556,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__42556,(4),null);
var arity = cljs.core.nth.call(null,vec__42556,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__42560 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__42560,(0),null);
var args = cljs.core.nth.call(null,vec__42560,(1),null);
var vec__42563 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__42563,(0),null);
var name = cljs.core.nth.call(null,vec__42563,(1),null);
...
var G__42566 = (arity + (1));
var G__42567 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
var arity = cljs.core.nth.call(null,vec__42569,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__42569,(1),null);
...
return cljs.core.get.call(null,arities,p1__42572_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__42573_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___42580 = arguments.length;
var i__4500__auto___42581 = (0);
while(true){
if((i__4500__auto___42581 < len__4499__auto___42580)){
args__4502__auto__.push((arguments[i__4500__auto___42581]));

var G__42582 = (i__4500__auto___42581 + (1));
i__4500__auto___42581 = G__42582;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42576){
var vec__42577 = p__42576;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__42577,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42574){
var G__42575 = cljs.core.first.call(null,seq42574);
var seq42574__$1 = cljs.core.next.call(null,seq42574);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42575,seq42574__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__42585__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__42585__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__42585__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__42585__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42586 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__42586,(0),null);
var fn_name = cljs.core.nth.call(null,vec__42586,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__42586,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__42586,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__42586,(4),null);
var arity = cljs.core.nth.call(null,vec__42586,(5),null);
...
var o__41437__auto__ = f;
return (o__41437__auto__["getBasis"]).call(o__41437__auto__);
});
/**
...
}catch (e42590){var _e__41444__auto__ = e42590;
...
var G__42591 = (obj[cljs.core.first.call(null,path)]);
var G__42592 = cljs.core.rest.call(null,path);
obj = G__42591;
path = G__42592;
continue;
} else {
...
return (function (accum,p__42593){
var vec__42594 = p__42593;
var bit = cljs.core.nth.call(null,vec__42594,(0),null);
var protocol = cljs.core.nth.call(null,vec__42594,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42597){
var vec__42598 = p__42597;
var ns = cljs.core.nth.call(null,vec__42598,(0),null);
var name = cljs.core.nth.call(null,vec__42598,(1),null);
var selector = cljs.core.nth.call(null,vec__42598,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__42603,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__42603,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__42603,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__42601_SHARP_){
return (obj[cljs.core.first.call(null,p1__42601_SHARP_)]);
});})(name,sorted_matches,vec__42603,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1530194905627
