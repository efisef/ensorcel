...
var file = cljs.core.get.call(null,map__24850__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__24850__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__24850__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5455__auto___24852 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___24852)){
var seen_errors_24853 = temp__5455__auto___24852;
if(cljs.core.truth_(seen_errors_24853.has(self))){
} else {
seen_errors_24853.add(self);

var temp__5457__auto___24854 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___24854)){
var sense_24855 = temp__5457__auto___24854;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24855)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1530194943243
