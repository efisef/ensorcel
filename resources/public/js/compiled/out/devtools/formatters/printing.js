...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42669){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42670,G__42671,seq42669__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42675_SHARP_){
return !((cljs.core.meta.call(null,p1__42675_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__42676__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42680){var _e__41444__auto__ = e42680;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e42682){var _e__41444__auto__ = e42682;
return false;
}}
})())){
...
var _STAR_current_state_STAR_42684 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__42685 = opts;
...
var markup_db = cljs.core.get.call(null,map__42685__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_42684;
}});
...
;
var temp__5455__auto___42689 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___42689)){
var managed_print_level_42690 = temp__5455__auto___42689;
var _STAR_print_level_STAR_42688_42691 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_42690;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_42688_42691,managed_print_level_42690,temp__5455__auto___42689,writer,opts,job_fn){
return (function (p1__42687_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__42687_SHARP_,null);
});})(_STAR_print_level_STAR_42688_42691,managed_print_level_42690,temp__5455__auto___42689,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_42688_42691;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1530194905996
