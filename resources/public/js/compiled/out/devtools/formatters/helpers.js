...
var G__42626 = devtools.prefs.pref.call(null,v);
v = G__42626;
continue;
} else {
return v;
...
}catch (e42629){var _e__41444__auto__ = e42629;
return false;
}})();
...
}catch (e42633){var _e__41444__auto__ = e42633;
return false;
}})();
...
}catch (e42635){var _e__41444__auto__ = e42635;
return false;
}}
}
});
...
var vec__42637 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__42637,(0),null);
var name = cljs.core.nth.call(null,vec__42637,(1),null);
...
return cljs.core.some.call(null,(function (p1__42640_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42640_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1530194905780
