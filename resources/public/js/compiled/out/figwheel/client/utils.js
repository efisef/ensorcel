...
return (new CustomEvent(event_name,(function (){var obj25140 = {"detail":data};
return obj25140;
})()));
} else {
...
var f = (function (){var pred__25147 = cljs.core._EQ_;
var expr__25148 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__25147.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__25148))){
return ((function (pred__25147,expr__25148){
return (function (p1__25141_SHARP_){
return console.warn(p1__25141_SHARP_);
});
;})(pred__25147,expr__25148))
} else {
if(cljs.core.truth_(pred__25147.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__25148))){
return ((function (pred__25147,expr__25148){
return (function (p1__25142_SHARP_){
return console.debug(p1__25142_SHARP_);
});
;})(pred__25147,expr__25148))
} else {
if(cljs.core.truth_(pred__25147.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__25148))){
return ((function (pred__25147,expr__25148){
return (function (p1__25143_SHARP_){
return console.error(p1__25143_SHARP_);
});
;})(pred__25147,expr__25148))
} else {
return ((function (pred__25147,expr__25148){
return (function (p1__25144_SHARP_){
return console.log(p1__25144_SHARP_);
});
;})(pred__25147,expr__25148))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__25151){
...
var eval_fn = cljs.core.get.call(null,map__25152__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__25154_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__25156,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1530194943987
